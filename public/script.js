...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Countdown timer
    function updateCountdown() {
        // Set the date for GVMUNC IX (updated to correct date)
    ...
    const animateElements = document.querySelectorAll('.highlight-card, .team-member, .stat-item');
    ...
    const cards = document.querySelectorAll('.highlight-card, .team-member, .partner-item');
    cards.forEach(card => {
    ...
    const statsObserver = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                if (number && !entry.target.hasAttribute('data-animated')) {
